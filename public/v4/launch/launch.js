...
(function () {
  ...
  function renderComposer() {
    ...
    if (!campaign) {
      body.innerHTML = `<div class="k-card lc-empty"><p>No campaign yet — <a href="/v4/app/">brief one in the workspace →</a></p></div>`;
      bar.hidden = true;
      return;
    }
    ...
    return `
      <div class="k-card kpi-strip">
        <div class="kpi-strip-head">
          ...
          <a class="kpi-edit" href="/v4/app/#m04">Edit targets →</a>
        </div>
